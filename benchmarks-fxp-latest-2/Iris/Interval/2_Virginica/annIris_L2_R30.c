...
int main() {
  ...
  int x0 = nondet_int();
  __ESBMC_assume((x0 >= 434) && (x0 <= 806));
  int x1 = nondet_int();
  __ESBMC_assume((x1 >= 238) && (x1 <= 442));
  int x2 = nondet_int();
  __ESBMC_assume((x2 >= 378) && (x2 <= 702));
  int x3 = nondet_int();
  __ESBMC_assume((x3 >= 161) && (x3 <= 299));
  ...
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(-0.977926015854)) &&
                 (layer1[0] <= fxp_float_to_fxp(-0.93827098608)));

  float w1[4] = {0.195045f, 0.474309f, -0.148397f, -0.079880f};
  float b1 = -0.016677f;
  fxp_t r1 = perform(w1, 4, i, 4, b1);
  layer1[1] = r1;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.608413994312)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.846875011921)));

  float w2[4] = {0.461122f, -0.476375f, 0.248677f, -0.553619f};
  float b2 = -0.017581f;
  fxp_t r2 = perform(w2, 4, i, 4, b2);
  layer1[2] = r2;
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(-0.851036012173)) &&
  ...
  layer1[3] = r3;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0.382854998112)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.942947983742)));

  float w4[4] = {0.405520f, 0.221390f, -0.391765f, 0.337188f};
  float b4 = -0.018501f;
  fxp_t r4 = perform(w4, 4, i, 4, b4);
  layer1[4] = r4;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.697492003441)) &&
                 (layer1[4] <= fxp_float_to_fxp(0.932340979576)));

  float w5[4] = {0.651486f, -0.367779f, -0.224814f, -0.037613f};
  float b5 = 0.077769f;
  fxp_t r5 = perform(w5, 4, i, 4, b5);
  layer1[5] = r5;
  __ESBMC_assume((layer1[5] >= fxp_float_to_fxp(-0.25317299366)) &&
                 (layer1[5] <= fxp_float_to_fxp(0.470023006201)));

  float w6[4] = {0.981716f, 0.727559f, -1.363340f, -1.402215f};
  float b6 = 0.674765f;
  fxp_t r6 = perform(w6, 4, i, 4, b6);
  layer1[6] = r6;
  __ESBMC_assume((layer1[6] >= fxp_float_to_fxp(-0.995473027229)) &&
                 (layer1[6] <= fxp_float_to_fxp(-0.34468498826)));
  ...
  layer2[0] = r20;
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(-0.20457200706)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.891748011112)));
  ...
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(-0.49056199193)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.85522800684)));
  ...
  layer2[2] = r22;
  __ESBMC_assume((layer2[2] >= fxp_float_to_fxp(-0.0696870014071)) &&
                 (layer2[2] <= fxp_float_to_fxp(0.798913002014)));
