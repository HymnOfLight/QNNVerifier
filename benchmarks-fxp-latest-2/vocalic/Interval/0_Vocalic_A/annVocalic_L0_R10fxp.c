...
int main() {
  ...
  layer1[0] = r10;
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(3.00000010611e-06)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.000150000007125)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.0316760018468)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.55477899313)));
  ...
  layer1[2] = r12;
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0.728693008423)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.994599997997)));
  ...
  layer1[3] = r13;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0.999922990799)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.999997973442)));
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.999512970448)) &&
                 (layer1[4] <= fxp_float_to_fxp(0.999979019165)));
  ...
  layer2[0] = r20;
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0.300902992487)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.851827025414)));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.995002985001)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.999526023865)));

  float w22[5] = {-2.927471f, -4.145836f, 1.903108f, 3.409983f, 0.191798f};
  float b22 = -4.116436f;
  fxp_t r22 = performf(w22, 5, layer1, 5, b22);
  layer2[2] = r22;
  __ESBMC_assume((layer2[2] >= fxp_float_to_fxp(0.193410992622)) &&
                 (layer2[2] <= fxp_float_to_fxp(0.776606976986)));

  float w23[5] = {-4.116436f, -7.171240f, 2.687001f, -1.662798f, 3.236128f};
  float b23 = 4.911131f;
  fxp_t r23 = performf(w23, 5, layer1, 5, b23);
  layer2[3] = r23;
  __ESBMC_assume((layer2[3] >= fxp_float_to_fxp(0.988581001759)) &&
                 (layer2[3] <= fxp_float_to_fxp(0.999867975712)));
  ...
  layer3[0] = r30;
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0.0118789998814)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.933516025543)));
  int r = 0;
  ...
  layer3[1] = r31;
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(3.9999999899e-06)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.00205400004052)));
  ...
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(0)) &&
                 (layer3[2] <= fxp_float_to_fxp(0.000201999995625)));
  ...
  layer3[4] = r34;
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0.000120999997307)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.00195399997756)));
