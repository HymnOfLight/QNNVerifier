...
int main() {
  ...
  int x21 = nondet_int();
  __ESBMC_assume((x21 >= 0) && (x21 <= 240));
  int x22 = nondet_int();
  __ESBMC_assume((x22 >= 0) && (x22 <= 240));
  int x23 = nondet_int();
  __ESBMC_assume((x23 >= 0) && (x23 <= 240));
  int x24 = nondet_int();
  ...
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.999998986721)));
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(9.99999997475e-07)) &&
  ...
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00154099997599)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.999868988991)));
  ...
  layer2[3] = r23;
  __ESBMC_assume((layer2[3] >= fxp_float_to_fxp(0.000322999985656)) &&
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.970372974873)));
