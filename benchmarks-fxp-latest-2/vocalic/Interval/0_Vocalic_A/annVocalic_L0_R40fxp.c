...
int main() {
  ...
  int x21 = nondet_int();
  __ESBMC_assume((x21 >= 0) && (x21 <= 80));
  int x22 = nondet_int();
  __ESBMC_assume((x22 >= 0) && (x22 <= 80));
  int x23 = nondet_int();
  __ESBMC_assume((x23 >= 0) && (x23 <= 80));
  int x24 = nondet_int();
  ...
  layer1[0] = r10;
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(9.20000020415e-05)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.997056007385)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.0214779991657)) &&
  ...
  layer1[2] = r12;
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(7.9999999798e-06)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.994274020195)));
  ...
  layer1[3] = r13;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0.00089999998454)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.999800026417)));
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.998727023602)) &&
  ...
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(1.99999999495e-06)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.997053027153)));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00155299995095)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.999531984329)));
  ...
  __ESBMC_assume((layer2[2] >= fxp_float_to_fxp(1.70000002981e-05)) &&
                 (layer2[2] <= fxp_float_to_fxp(0.783639013767)));

  float w23[5] = {-4.116436f, -7.171240f, 2.687001f, -1.662798f, 3.236128f};
  float b23 = 4.911131f;
  fxp_t r23 = performf(w23, 5, layer1, 5, b23);
  layer2[3] = r23;
  __ESBMC_assume((layer2[3] >= fxp_float_to_fxp(0.00821099989116)) &&
                 (layer2[3] <= fxp_float_to_fxp(0.999976992607)));
  ...
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(3.9999999899e-06)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.977135002613)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.991590976715)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.989001989365)));
