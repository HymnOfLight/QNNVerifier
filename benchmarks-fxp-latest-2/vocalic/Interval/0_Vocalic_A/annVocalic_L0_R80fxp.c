...
int main() {
  ...
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.999971985817)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(9.99999997475e-07)) &&
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.0393540002406)) &&
  ...
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00154099997599)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.999862015247)));
  ...
  layer2[3] = r23;
  __ESBMC_assume((layer2[3] >= fxp_float_to_fxp(0.000367000000551)) &&
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.989829003811)));
