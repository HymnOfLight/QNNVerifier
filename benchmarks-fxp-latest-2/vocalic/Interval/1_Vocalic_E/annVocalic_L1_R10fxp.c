...
int main() {
  ...
  int x1 = nondet_int();
  __ESBMC_assume((x1 >= 235) && (x1 <= 255));
  int x2 = nondet_int();
  __ESBMC_assume((x2 >= 235) && (x2 <= 255));
  int x3 = nondet_int();
  __ESBMC_assume((x3 >= 235) && (x3 <= 255));
  int x4 = nondet_int();
  ...
  int x11 = nondet_int();
  __ESBMC_assume((x11 >= 235) && (x11 <= 255));
  int x12 = nondet_int();
  __ESBMC_assume((x12 >= 235) && (x12 <= 255));
  int x13 = nondet_int();
  __ESBMC_assume((x13 >= 235) && (x13 <= 255));
  int x14 = nondet_int();
  ...
  // unsigned int x2 = Frama_C_interval(235, 255);
  // unsigned int x3 = Frama_C_interval(235, 255);
  ...
  // unsigned int x9 = Frama_C_interval(0, 20);
  // unsigned int x10 = Frama_C_interval(235, 255);
  // unsigned int x11 = Frama_C_interval(235, 255);
  // unsigned int x12 = Frama_C_interval(235, 255);
  // unsigned int x13 = Frama_C_interval(235, 255);
  ...
  // unsigned int x19 = Frama_C_interval(0, 20);
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.173647001386)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.887952983379)));
  ...
  layer1[2] = r12;
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0.0140639999881)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.495000004768)));
  ...
  layer1[3] = r13;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0.0183429997414)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.477515012026)));
  ...
  layer1[4] = r14;
  __ESBMC_assume(layer1[4] = fxp_float_to_fxp(1));
  ...
  layer2[0] = r20;
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0.08166000247)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.968016028404)));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00537799997255)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.798991024494)));
  ...
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.102476999164)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.988108992577)));
  ...
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(0)) &&
                 (layer3[2] <= fxp_float_to_fxp(0.916061997414)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.0033350000158)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.011429999955)));
