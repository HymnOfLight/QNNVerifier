...
int main() {
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.0279229991138)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.976568996906)));
  ...
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.897522985935)));
  ...
  layer1[3] = r13;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0.00336800003424)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.887952983379)));
  ...
  layer2[0] = r20;
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0.0121280001476)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.995635986328)));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00399000011384)) &&
  ...
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.944799005985)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.991250991821)));
  ...
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(0)) &&
                 (layer3[2] <= fxp_float_to_fxp(0.96045601368)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.161109000444)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.617748022079)));
