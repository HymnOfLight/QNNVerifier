...
int main() {
  ...
  int x11 = nondet_int();
  __ESBMC_assume((x11 >= 175) && (x11 <= 255));
  int x12 = nondet_int();
  __ESBMC_assume((x12 >= 175) && (x12 <= 255));
  int x13 = nondet_int();
  __ESBMC_assume((x13 >= 175) && (x13 <= 255));
  int x14 = nondet_int();
  ...
  // unsigned int x11 = Frama_C_interval(175, 255);
  // unsigned int x12 = Frama_C_interval(175, 255);
  // unsigned int x13 = Frama_C_interval(175, 255);
  ...
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.125648006797)));
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.99098700285)) &&
  ...
  layer2[0] = r20;
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0.00247299997136)) &&
  ...
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00336800003424)) &&
  ...
  layer2[3] = r23;
  __ESBMC_assume((layer2[3] >= fxp_float_to_fxp(0.226181000471)) &&
  ...
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.978119015694)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.991421997547)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.670400977135)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.914511024952)));
