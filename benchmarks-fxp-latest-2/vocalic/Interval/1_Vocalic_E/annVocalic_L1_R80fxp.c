...
int main() {
  ...
  int x11 = nondet_int();
  __ESBMC_assume((x11 >= 95) && (x11 <= 255));
  int x12 = nondet_int();
  __ESBMC_assume((x12 >= 95) && (x12 <= 255));
  int x13 = nondet_int();
  __ESBMC_assume((x13 >= 95) && (x13 <= 255));
  int x14 = nondet_int();
  ...
  // unsigned int x9 = Frama_C_interval(0, 160);
  // unsigned int x10 = Frama_C_interval(95, 255);
  // unsigned int x11 = Frama_C_interval(95, 255);
  // unsigned int x12 = Frama_C_interval(95, 255);
  // unsigned int x13 = Frama_C_interval(95, 255);
  ...
  // unsigned int x19 = Frama_C_interval(0, 160);
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.0139260003343)) &&
