...
int main() {
  ...
  int x17 = nondet_int();
  __ESBMC_assume((x17 >= 235) && (x17 <= 255));
  int x18 = nondet_int();
  ...
  layer1[0] = r10;
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0.0345560014248)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.608259022236)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.196234002709)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.902031004429)));
  ...
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.114051997662)));
  ...
  layer2[0] = r20;
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0.00350499991328)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.845534980297)));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00252200011164)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.0227540004998)));
  ...
  layer3[0] = r30;
  __ESBMC_assume((layer3[fxp_float_to_fxp(0)] == fxp_float_to_fxp(0)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.959300994873)));
  ...
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(0)) &&
                 (layer3[2] <= fxp_float_to_fxp(0.964429020882)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.437824010849)));
