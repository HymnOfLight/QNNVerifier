...
int main() {
  ...
  int x5 = nondet_int();
  __ESBMC_assume((x5 >= 0) && (x5 <= 40));
  int x6 = nondet_int();
  __ESBMC_assume((x6 >= 0) && (x6 <= 40));
  int x7 = nondet_int();
  __ESBMC_assume((x7 >= 215) && (x7 <= 255));
  int x8 = nondet_int();
  __ESBMC_assume((x8 >= 0) && (x8 <= 40));
  int x9 = nondet_int();
  __ESBMC_assume((x9 >= 0) && (x9 <= 40));
  int x10 = nondet_int();
  __ESBMC_assume((x10 >= 0) && (x10 <= 40));
  int x11 = nondet_int();
  ...
  int x14 = nondet_int();
  __ESBMC_assume((x14 >= 0) && (x14 <= 40));
  int x15 = nondet_int();
  __ESBMC_assume((x15 >= 0) && (x15 <= 40));
  int x16 = nondet_int();
  __ESBMC_assume((x16 >= 0) && (x16 <= 40));
  int x17 = nondet_int();
  __ESBMC_assume((x17 >= 215) && (x17 <= 255));
  int x18 = nondet_int();
  __ESBMC_assume((x18 >= 0) && (x18 <= 40));
  int x19 = nondet_int();
  __ESBMC_assume((x19 >= 0) && (x19 <= 40));
  int x20 = nondet_int();
  ...
  // unsigned int x5 = Frama_C_interval(0, 40);
  // unsigned int x6 = Frama_C_interval(0, 40);
  // unsigned int x7 = Frama_C_interval(215, 255);
  // unsigned int x8 = Frama_C_interval(0, 40);
  // unsigned int x9 = Frama_C_interval(0, 40);
  // unsigned int x10 = Frama_C_interval(0, 40);
  // unsigned int x11 = Frama_C_interval(0, 40);
  // unsigned int x12 = Frama_C_interval(215, 255);
  // unsigned int x13 = Frama_C_interval(0, 40);
  // unsigned int x14 = Frama_C_interval(0, 40);
  // unsigned int x15 = Frama_C_interval(0, 40);
  // unsigned int x16 = Frama_C_interval(0, 40);
  // unsigned int x17 = Frama_C_interval(215, 255);
  // unsigned int x18 = Frama_C_interval(0, 40);
  // unsigned int x19 = Frama_C_interval(0, 40);
  ...
  layer1[0] = r10;
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0.00304899993353)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.853209972382)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.0322949998081)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.979568004608)));
  ...
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.57688498497)));
  ...
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.985225975513)));
  ...
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.331811994314)));
  ...
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.00901299994439)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.990621984005)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.922011971474)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.140637993813)));
