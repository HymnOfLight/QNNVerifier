...
int main() {
  ...
  int x0 = nondet_int();
  __ESBMC_assume((x0 >= 175) && (x0 <= 255));
  int x1 = nondet_int();
  __ESBMC_assume((x1 >= 175) && (x1 <= 255));
  int x2 = nondet_int();
  __ESBMC_assume((x2 >= 175) && (x2 <= 255));
  int x3 = nondet_int();
  __ESBMC_assume((x3 >= 175) && (x3 <= 255));
  int x4 = nondet_int();
  __ESBMC_assume((x4 >= 175) && (x4 <= 255));
  int x5 = nondet_int();
  __ESBMC_assume((x5 >= 0) && (x5 <= 80));
  int x6 = nondet_int();
  __ESBMC_assume((x6 >= 0) && (x6 <= 80));
  int x7 = nondet_int();
  __ESBMC_assume((x7 >= 175) && (x7 <= 255));
  int x8 = nondet_int();
  __ESBMC_assume((x8 >= 0) && (x8 <= 80));
  int x9 = nondet_int();
  __ESBMC_assume((x9 >= 0) && (x9 <= 80));
  int x10 = nondet_int();
  __ESBMC_assume((x10 >= 0) && (x10 <= 80));
  int x11 = nondet_int();
  __ESBMC_assume((x11 >= 0) && (x11 <= 80));
  int x12 = nondet_int();
  __ESBMC_assume((x12 >= 175) && (x12 <= 255));
  int x13 = nondet_int();
  __ESBMC_assume((x13 >= 0) && (x13 <= 80));
  int x14 = nondet_int();
  __ESBMC_assume((x14 >= 0) && (x14 <= 80));
  int x15 = nondet_int();
  __ESBMC_assume((x15 >= 0) && (x15 <= 80));
  int x16 = nondet_int();
  __ESBMC_assume((x16 >= 0) && (x16 <= 80));
  int x17 = nondet_int();
  __ESBMC_assume((x17 >= 175) && (x17 <= 255));
  int x18 = nondet_int();
  __ESBMC_assume((x18 >= 0) && (x18 <= 80));
  int x19 = nondet_int();
  __ESBMC_assume((x19 >= 0) && (x19 <= 80));
  int x20 = nondet_int();
  __ESBMC_assume((x20 >= 175) && (x20 <= 255));
  int x21 = nondet_int();
  __ESBMC_assume((x21 >= 175) && (x21 <= 255));
  int x22 = nondet_int();
  __ESBMC_assume((x22 >= 175) && (x22 <= 255));
  int x23 = nondet_int();
  ...
  // unsigned int x5 = Frama_C_interval(0, 80);
  // unsigned int x6 = Frama_C_interval(0, 80);
  // unsigned int x7 = Frama_C_interval(175, 255);
  // unsigned int x8 = Frama_C_interval(0, 80);
  // unsigned int x9 = Frama_C_interval(0, 80);
  // unsigned int x10 = Frama_C_interval(0, 80);
  // unsigned int x11 = Frama_C_interval(0, 80);
  // unsigned int x12 = Frama_C_interval(175, 255);
  // unsigned int x13 = Frama_C_interval(0, 80);
  // unsigned int x14 = Frama_C_interval(0, 80);
  // unsigned int x15 = Frama_C_interval(0, 80);
  // unsigned int x16 = Frama_C_interval(0, 80);
  // unsigned int x17 = Frama_C_interval(175, 255);
  // unsigned int x18 = Frama_C_interval(0, 80);
  // unsigned int x19 = Frama_C_interval(0, 80);
  ...
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.98799097538)));
  ...
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.993694007397)));
  ...
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.325195014477)));
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.944799005985)) &&
  ...
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.997241020203)));
  ...
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.978542983532)));
  ...
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.562175989151)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.961947977543)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.985080003738)));
