...
int main() {
  ...
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.997040987015)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.0216680001467)) &&
  ...
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.994234025478)));
  ...
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.997040987015)));
  ...
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.976796984673)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.967703998089)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.989013016224)));
