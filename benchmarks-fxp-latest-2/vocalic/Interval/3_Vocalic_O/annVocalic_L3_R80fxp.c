...
int main() {
  ...
  int x0 = nondet_int();
  __ESBMC_assume((x0 >= 95) && (x0 <= 255));
  int x1 = nondet_int();
  __ESBMC_assume((x1 >= 95) && (x1 <= 255));
  int x2 = nondet_int();
  __ESBMC_assume((x2 >= 95) && (x2 <= 255));
  int x3 = nondet_int();
  __ESBMC_assume((x3 >= 95) && (x3 <= 255));
  int x4 = nondet_int();
  __ESBMC_assume((x4 >= 95) && (x4 <= 255));
  int x5 = nondet_int();
  __ESBMC_assume((x5 >= 95) && (x5 <= 255));
  int x6 = nondet_int();
  ...
  int x9 = nondet_int();
  __ESBMC_assume((x9 >= 95) && (x9 <= 255));
  int x10 = nondet_int();
  __ESBMC_assume((x10 >= 95) && (x10 <= 255));
  int x11 = nondet_int();
  ...
  int x14 = nondet_int();
  __ESBMC_assume((x14 >= 95) && (x14 <= 255));
  int x15 = nondet_int();
  __ESBMC_assume((x15 >= 95) && (x15 <= 255));
  int x16 = nondet_int();
  ...
  int x19 = nondet_int();
  __ESBMC_assume((x19 >= 95) && (x19 <= 255));
  int x20 = nondet_int();
  __ESBMC_assume((x20 >= 95) && (x20 <= 255));
  int x21 = nondet_int();
  __ESBMC_assume((x21 >= 95) && (x21 <= 255));
  int x22 = nondet_int();
  __ESBMC_assume((x22 >= 95) && (x22 <= 255));
  int x23 = nondet_int();
  __ESBMC_assume((x23 >= 95) && (x23 <= 255));
  int x24 = nondet_int();
  __ESBMC_assume((x24 >= 95) && (x24 <= 255));
  // unsigned int x0 = Frama_C_interval(95, 255);
  // unsigned int x1 = Frama_C_interval(95, 255);
  // unsigned int x2 = Frama_C_interval(95, 255);
  // unsigned int x3 = Frama_C_interval(95, 255);
  // unsigned int x4 = Frama_C_interval(95, 255);
  // unsigned int x5 = Frama_C_interval(95, 255);
  // unsigned int x6 = Frama_C_interval(0, 160);
  // unsigned int x7 = Frama_C_interval(0, 160);
  // unsigned int x8 = Frama_C_interval(0, 160);
  // unsigned int x9 = Frama_C_interval(95, 255);
  // unsigned int x10 = Frama_C_interval(95, 255);
  // unsigned int x11 = Frama_C_interval(0, 160);
  // unsigned int x12 = Frama_C_interval(0, 160);
  // unsigned int x13 = Frama_C_interval(0, 160);
  // unsigned int x14 = Frama_C_interval(95, 255);
  // unsigned int x15 = Frama_C_interval(95, 255);
  // unsigned int x16 = Frama_C_interval(0, 160);
  // unsigned int x17 = Frama_C_interval(0, 160);
  // unsigned int x18 = Frama_C_interval(0, 160);
  // unsigned int x19 = Frama_C_interval(95, 255);
  // unsigned int x20 = Frama_C_interval(95, 255);
  // unsigned int x21 = Frama_C_interval(95, 255);
  // unsigned int x22 = Frama_C_interval(95, 255);
  // unsigned int x23 = Frama_C_interval(95, 255);
  // unsigned int x24 = Frama_C_interval(95, 255);
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.0395440012217)) &&
  ...
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.997295022011)));
  ...
  __ESBMC_assume((layer2[2] >= fxp_float_to_fxp(0)) &&
                 (layer2[2] <= fxp_float_to_fxp(0.798991024494)));
  ...
  layer3[0] = r30;
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.979367017746)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.991674005985)));
  ...
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(0)) &&
                 (layer3[2] <= fxp_float_to_fxp(0.96643102169)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.97068798542)));
  ...
  layer3[4] = r34;
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.989848971367)));
  if (fxp_to_float(layer3[4]) > fxp_to_float(layer3[r]))
    r = 4;
  __ESBMC_assert(r == 3, "Classification is not a 3 anymore.");
  //@assert(r == 3);
}
