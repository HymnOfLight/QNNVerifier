...
int main() {
  ...
  int x4 = nondet_int();
  __ESBMC_assume((x4 >= 235) && (x4 <= 255));
  int x5 = nondet_int();
  __ESBMC_assume((x5 >= 235) && (x5 <= 255));
  int x6 = nondet_int();
  ...
  int x9 = nondet_int();
  __ESBMC_assume((x9 >= 235) && (x9 <= 255));
  int x10 = nondet_int();
  __ESBMC_assume((x10 >= 235) && (x10 <= 255));
  int x11 = nondet_int();
  ...
  int x14 = nondet_int();
  __ESBMC_assume((x14 >= 235) && (x14 <= 255));
  int x15 = nondet_int();
  __ESBMC_assume((x15 >= 235) && (x15 <= 255));
  int x16 = nondet_int();
  ...
  int x19 = nondet_int();
  __ESBMC_assume((x19 >= 235) && (x19 <= 255));
  int x20 = nondet_int();
  __ESBMC_assume((x20 >= 235) && (x20 <= 255));
  int x21 = nondet_int();
  __ESBMC_assume((x21 >= 235) && (x21 <= 255));
  int x22 = nondet_int();
  __ESBMC_assume((x22 >= 235) && (x22 <= 255));
  int x23 = nondet_int();
  __ESBMC_assume((x23 >= 235) && (x23 <= 255));
  int x24 = nondet_int();
  __ESBMC_assume((x24 >= 235) && (x24 <= 255));
  ...
  // unsigned int x4 = Frama_C_interval(235, 255);
  // unsigned int x5 = Frama_C_interval(235, 255);
  // unsigned int x6 = Frama_C_interval(0, 20);
  // unsigned int x7 = Frama_C_interval(0, 20);
  // unsigned int x8 = Frama_C_interval(0, 20);
  // unsigned int x9 = Frama_C_interval(235, 255);
  // unsigned int x10 = Frama_C_interval(235, 255);
  // unsigned int x11 = Frama_C_interval(0, 20);
  // unsigned int x12 = Frama_C_interval(0, 20);
  // unsigned int x13 = Frama_C_interval(0, 20);
  // unsigned int x14 = Frama_C_interval(235, 255);
  // unsigned int x15 = Frama_C_interval(235, 255);
  // unsigned int x16 = Frama_C_interval(0, 20);
  // unsigned int x17 = Frama_C_interval(0, 20);
  // unsigned int x18 = Frama_C_interval(0, 20);
  // unsigned int x19 = Frama_C_interval(235, 255);
  // unsigned int x20 = Frama_C_interval(235, 255);
  // unsigned int x21 = Frama_C_interval(235, 255);
  // unsigned int x22 = Frama_C_interval(235, 255);
  // unsigned int x23 = Frama_C_interval(235, 255);
  // unsigned int x24 = Frama_C_interval(235, 255);
  ...
  layer1[0] = r10;
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0.84966802597)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.995974004269)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.999154984951)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.999978005886)));
  ...
  layer1[2] = r12;
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0.956477999687)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.999337017536)));
  ...
  layer1[3] = r13;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0.86294901371)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.996738016605)));
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.99999499321)) &&
                 (layer1[4] <= fxp_float_to_fxp(1)));
  ...
  layer2[0] = r20;
  __ESBMC_assume(((layer2[0] >= fxp_float_to_fxp(6.60000005155e-05)) &&
                  (layer2[0] <= fxp_float_to_fxp(0.000453999993624))));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume(((layer2[1] >= fxp_float_to_fxp(0.98704200983)) &&
                  (layer2[1] <= fxp_float_to_fxp(0.995949983597))));

  float w22[5] = {-2.927471f, -4.145836f, 1.903108f, 3.409983f, 0.191798f};
  float b22 = -4.116436f;
  fxp_t r22 = performf(w22, 5, layer1, 5, b22);
  layer2[2] = r22;
  __ESBMC_assume(((layer2[2] >= fxp_float_to_fxp(0.00197899993509)) &&
                  (layer2[2] <= fxp_float_to_fxp(0.0052049998194))));

  float w23[5] = {-4.116436f, -7.171240f, 2.687001f, -1.662798f, 3.236128f};
  float b23 = 4.911131f;
  fxp_t r23 = performf(w23, 5, layer1, 5, b23);
  layer2[3] = r23;
  __ESBMC_assume(((layer2[3] >= fxp_float_to_fxp(0.0987669974566)) &&
                  (layer2[3] <= fxp_float_to_fxp(0.22011500597))));
  ...
  layer3[0] = r30;
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(0.000717999995686)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.000793999992311)));
  int r = 0;
  ...
  layer3[2] = r32;
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(1.99999999495e-06)) &&
                 (layer3[2] <= fxp_float_to_fxp(6.00000021223e-06)));
  ...
  layer3[3] = r33;
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0.00219999998808)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.0102620003745)));
  ...
  layer3[4] = r34;
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0.91084498167)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.97301197052)));
