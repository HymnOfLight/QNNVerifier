...
int main() {
  ...
  layer1[0] = r10;
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0.239941999316)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.998347997665)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.98730802536)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.999990999699)));
  ...
  layer1[2] = r12;
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0.607544004917)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.999863028526)));
  ...
  layer1[3] = r13;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0.409750014544)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.999387979507)));
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.99994802475)) &&
  ...
  layer2[0] = r20;
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(1.70000002981e-05)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.321911990643)));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.397235006094)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.997730970383)));

  float w22[5] = {-2.927471f, -4.145836f, 1.903108f, 3.409983f, 0.191798f};
  float b22 = -4.116436f;
  fxp_t r22 = performf(w22, 5, layer1, 5, b22);
  layer2[2] = r22;
  __ESBMC_assume((layer2[2] >= fxp_float_to_fxp(0.000216000000364)) &&
                 (layer2[2] <= fxp_float_to_fxp(0.0320149995387)));

  float w23[5] = {-4.116436f, -7.171240f, 2.687001f, -1.662798f, 3.236128f};
  float b23 = 4.911131f;
  fxp_t r23 = performf(w23, 5, layer1, 5, b23);
  layer2[3] = r23;
  __ESBMC_assume((layer2[3] >= fxp_float_to_fxp(0.0405820012093)) &&
                 (layer2[3] <= fxp_float_to_fxp(0.88933801651)));
  ...
  layer3[0] = r30;
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(2.99999992421e-05)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.00582899991423)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.00177700002678)));
  ...
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(0)) &&
                 (layer3[2] <= fxp_float_to_fxp(0.291316002607)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.560945987701)));
  ...
  layer3[4] = r34;
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(4.30000000051e-05)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.984767973423)));
