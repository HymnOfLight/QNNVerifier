...
int main() {
  ...
  int x1 = nondet_int();
  __ESBMC_assume((x1 >= 0) && (x1 <= 80));
  int x2 = nondet_int();
  __ESBMC_assume((x2 >= 0) && (x2 <= 80));
  int x3 = nondet_int();
  __ESBMC_assume((x3 >= 0) && (x3 <= 80));
  int x4 = nondet_int();
  __ESBMC_assume((x4 >= 175) && (x4 <= 255));
  int x5 = nondet_int();
  __ESBMC_assume((x5 >= 175) && (x5 <= 255));
  int x6 = nondet_int();
  __ESBMC_assume((x6 >= 0) && (x6 <= 80));
  int x7 = nondet_int();
  __ESBMC_assume((x7 >= 0) && (x7 <= 80));
  int x8 = nondet_int();
  __ESBMC_assume((x8 >= 0) && (x8 <= 80));
  int x9 = nondet_int();
  __ESBMC_assume((x9 >= 175) && (x9 <= 255));
  int x10 = nondet_int();
  __ESBMC_assume((x10 >= 175) && (x10 <= 255));
  int x11 = nondet_int();
  __ESBMC_assume((x11 >= 0) && (x11 <= 80));
  int x12 = nondet_int();
  __ESBMC_assume((x12 >= 0) && (x12 <= 80));
  int x13 = nondet_int();
  __ESBMC_assume((x13 >= 0) && (x13 <= 80));
  int x14 = nondet_int();
  __ESBMC_assume((x14 >= 175) && (x14 <= 255));
  int x15 = nondet_int();
  __ESBMC_assume((x15 >= 175) && (x15 <= 255));
  int x16 = nondet_int();
  __ESBMC_assume((x16 >= 0) && (x16 <= 80));
  int x17 = nondet_int();
  __ESBMC_assume((x17 >= 0) && (x17 <= 80));
  int x18 = nondet_int();
  __ESBMC_assume((x18 >= 0) && (x18 <= 80));
  int x19 = nondet_int();
  __ESBMC_assume((x19 >= 175) && (x19 <= 255));
  int x20 = nondet_int();
  ...
  // unsigned int x1 = Frama_C_interval(0, 80);
  // unsigned int x2 = Frama_C_interval(0, 80);
  // unsigned int x3 = Frama_C_interval(0, 80);
  ...
  layer1[0] = r10;
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0.000980000011623)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.999722003937)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(0.251994997263)) &&
                 (layer1[1] <= fxp_float_to_fxp(0.999998986721)));
  ...
  layer1[2] = r12;
  __ESBMC_assume((layer1[2] >= fxp_float_to_fxp(0.00762999989092)) &&
                 (layer1[2] <= fxp_float_to_fxp(0.999993979931)));
  ...
  layer1[3] = r13;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(0.00835900008678)) &&
                 (layer1[3] <= fxp_float_to_fxp(0.999979019165)));
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.994790017605)) &&
  ...
  layer2[0] = r20;
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(1.99999999495e-06)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.99398201704)));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00169599999208)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.999372005463)));

  float w22[5] = {-2.927471f, -4.145836f, 1.903108f, 3.409983f, 0.191798f};
  float b22 = -4.116436f;
  fxp_t r22 = performf(w22, 5, layer1, 5, b22);
  layer2[2] = r22;
  __ESBMC_assume((layer2[2] >= fxp_float_to_fxp(1.70000002981e-05)) &&
                 (layer2[2] <= fxp_float_to_fxp(0.584191024303)));

  float w23[5] = {-4.116436f, -7.171240f, 2.687001f, -1.662798f, 3.236128f};
  float b23 = 4.911131f;
  fxp_t r23 = performf(w23, 5, layer1, 5, b23);
  layer2[3] = r23;
  __ESBMC_assume((layer2[3] >= fxp_float_to_fxp(0.0081789996475)) &&
                 (layer2[3] <= fxp_float_to_fxp(0.999877989292)));
  ...
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(3.9999999899e-06)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.915367007256)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.991303026676)));
  ...
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(0)) &&
                 (layer3[2] <= fxp_float_to_fxp(0.966072022915)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.967454016209)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.98899102211)));
