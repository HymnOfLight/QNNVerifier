...
int main() {
  ...
  // unsigned int x1 = Frama_C_interval(0, 160);
  // unsigned int x2 = Frama_C_interval(0, 160);
  // unsigned int x3 = Frama_C_interval(0, 160);
  ...
  __ESBMC_assume((layer1[0] >= fxp_float_to_fxp(0)) &&
                 (layer1[0] <= fxp_float_to_fxp(0.999992012978)));
  ...
  layer1[1] = r11;
  __ESBMC_assume((layer1[1] >= fxp_float_to_fxp(6.00000021223e-06)) &&
  ...
  layer1[3] = r13;
  __ESBMC_assume((layer1[3] >= fxp_float_to_fxp(9.99999997475e-07)) &&
  ...
  layer1[4] = r14;
  __ESBMC_assume((layer1[4] >= fxp_float_to_fxp(0.0186880007386)) &&
  ...
  __ESBMC_assume((layer2[0] >= fxp_float_to_fxp(0)) &&
                 (layer2[0] <= fxp_float_to_fxp(0.997309029102)));

  float w21[5] = {-0.894016f, -1.446080f, 6.029086f, 5.837497f, -1.206468f};
  float b21 = -2.927471f;
  fxp_t r21 = performf(w21, 5, layer1, 5, b21);
  layer2[1] = r21;
  __ESBMC_assume((layer2[1] >= fxp_float_to_fxp(0.00154099997599)) &&
                 (layer2[1] <= fxp_float_to_fxp(0.999866008759)));

  float w22[5] = {-2.927471f, -4.145836f, 1.903108f, 3.409983f, 0.191798f};
  float b22 = -4.116436f;
  fxp_t r22 = performf(w22, 5, layer1, 5, b22);
  layer2[2] = r22;
  __ESBMC_assume((layer2[2] >= fxp_float_to_fxp(1.4000000192e-05)) &&
                 (layer2[2] <= fxp_float_to_fxp(0.800273001194)));

  float w23[5] = {-4.116436f, -7.171240f, 2.687001f, -1.662798f, 3.236128f};
  float b23 = 4.911131f;
  fxp_t r23 = performf(w23, 5, layer1, 5, b23);
  layer2[3] = r23;
  __ESBMC_assume((layer2[3] >= fxp_float_to_fxp(0.000342999992426)) &&
                 (layer2[3] <= fxp_float_to_fxp(0.999979972839)));
  ...
  layer3[0] = r30;
  __ESBMC_assume((layer3[0] >= fxp_float_to_fxp(3.9999999899e-06)) &&
                 (layer3[0] <= fxp_float_to_fxp(0.979628026485)));
  int r = 0;
  ...
  __ESBMC_assume((layer3[1] >= fxp_float_to_fxp(0)) &&
                 (layer3[1] <= fxp_float_to_fxp(0.991616010666)));
  ...
  __ESBMC_assume((layer3[2] >= fxp_float_to_fxp(0)) &&
                 (layer3[2] <= fxp_float_to_fxp(0.966170012951)));
  ...
  __ESBMC_assume((layer3[3] >= fxp_float_to_fxp(0)) &&
                 (layer3[3] <= fxp_float_to_fxp(0.970344007015)));
  ...
  __ESBMC_assume((layer3[4] >= fxp_float_to_fxp(0)) &&
                 (layer3[4] <= fxp_float_to_fxp(0.989839017391)));
